      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            ...
            >
              <Building size={16} className="mr-2" style={{ color: 'var(--primary)' }} />
              LodgeCity | {selectedLocation === 'Canada' ? '🇨🇦 Canada' : '🇵🇰 Pakistan'}
            </motion.span>
          </motion.div>
              ...
              <div className="relative z-10">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <label className="text-xs block mb-1 text-white/70 font-medium">City</label>
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center text-white">
                    ...
                    <span className="text-lg">Search Available Apartments</span>
                    <motion.div
                      whileHover={{ x: 8 }}
                      transition={{ duration: 0.3 }}
                    >
          ...
          <motion.div variants={itemVariants} className="flex justify-center space-x-12 text-center">
            {[
              { number: "200+", label: "City Properties", icon: Building },
              { number: "50K+", label: "Urban Guests", icon: Star },
              { number: "4.8", label: "City Rating", icon: MapPin }
            ].map((stat, index) => (
              <motion.div 
                key={index}
